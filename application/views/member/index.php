		...
		<div class="card mb-3">
			<div class="card-header">
				...
				<div class="pull-right">
					<a href="<?php echo site_url('member/main_form'); ?>" role="button" class="btn btn-dark btn-create" data-toggle="modal" data-target="#ajaxLargeModal"><?php echo line('create'); ?></a>
				</div>				
			</div>

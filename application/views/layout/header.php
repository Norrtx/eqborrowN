	...
	<div id="main">
						...
						<div class="dropdown-menu dropdown-menu-right profile-dropdown">
							...
							<div class="dropdown-item noti-title">
								<h5 class="text-overflow">
									<small>Hello, <?php echo get_username(); ?></small>
								</h5>
							</div>
		...
		<div class="left main-sidebar">
			...
			<div class="sidebar-inner leftscroll">
				<div class="app-sidebar__user"><img class="app-sidebar__user-avatar sidebar__user-avatar" src="<?php echo base_url('assets/images/avatars/admin.png'); ?>" alt="User Image">
					<div>

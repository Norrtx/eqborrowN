			...
			<div class="card-header">
				...
				<div class="pull-right">
					<form class="form-inline">
						...
						<a href="<?php echo site_url('product/main_form'); ?>" role="button" class="btn btn-dark btn-create" data-toggle="modal" data-target="#ajaxLargeModal"><?php echo line('create'); ?></a>
					</form>

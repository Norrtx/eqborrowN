...
class Borrows extends REST_Controller
{
    ...
    public function index_get()
    {
        $id = $this->get('id');
        if ($id === null) {
            $data = $this->Borrow_model->find_all();
        } else {
            ...
            if(!empty($data)){
                ...
                foreach($fields as $val){
                    $data[$val]['value'] = !empty($data[$val.'_id']) ? $data[$val.'_id'] : null;
                    $data[$val]['label'] = !empty($data[$val.'_name']) ? $data[$val.'_name'] : null;
                }
    ...
    public function index_post()
    {
        ...
        $row['schedule_date'] = db_date($post['schedule_date']);        

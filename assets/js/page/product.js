		...
		'columns': [
			{
				...
				render: function(data, type, row) {
					return data ?
					'<img src="'+gUrl +'uploads/img/'+fullimage(data,'_sm')+'" alt="รูปภาพ" class="img-fluid rounded mx-auto d-block profile-picture-list" style="width: 50px;">'
					: '<img src="'+gUrl +'assets/images/image.png" alt="รูปภาพ" class="img-fluid rounded mx-auto d-block profile-picture-list" style="width: 50px;">';
				}
			},
			{
				data: 'code',

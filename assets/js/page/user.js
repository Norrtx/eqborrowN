		...
		'columns': [
            ...
            },
            {
                ...
                render: function(data, type, row){
                    var result;
                    if(data === 'ADMIN'){
                        result = '<span class="badge badge-pill badge-primary">Admin</span>';
                    } else {
                        result = '<span class="badge badge-pill badge-secondary">User</span>';
                    }
                    return result;
                }
            },
			...
			},
			{
				...
				render: function (data, type, row) {
					...
					var btnDelete = '<a href="#" data-href="' + gUrl + 'api/users/' + data + '" data-id="' + data + '" data-name="' + dataName + '" role="button" class="btn btn-outline-danger btn-sm btn-delete"><i class="fa fa-trash"></i> ' + gDelete + '</a>';
